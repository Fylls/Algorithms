// Pig latin is created by taking all the consonants before the first vowel of a word and moving them to
// the back of the word followed by the letters "ay".
...
// Also, there will never be punctuation at the beginning of a word and the only capital letter in a word will be the first letter meaning
// there are zero all capitalized words.

function translate(sentence) {
  const vowels = "aeiou".split("")
  const wordsArray = sentence.split(" ")

  return wordsArray.map(word => {}).join(" ")
}
